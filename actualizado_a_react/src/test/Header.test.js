...
describe('Header Component', () => {
  ...
  describe('Responsividad móvil', () => {
    ...
    it('debería mostrar botón hamburguesa en móvil', () => {
      renderWithRouter(<Header />)
    ...
    it('debería mostrar/ocultar menú móvil', () => {
      renderWithRouter(<Header />)
  ...
  describe('Interacciones', () => {
    it('debería manejar hover en enlaces', () => {
      renderWithRouter(<Header />)
      
      const inicioLink = screen.getByText('Inicio')
      fireEvent.mouseEnter(inicioLink)
      
      // Debería aplicar estilos de hover
      expect(inicioLink).toHaveClass('hover')
    })

    it('debería manejar clic en enlaces', () => {
      renderWithRouter(<Header />)
  ...
  describe('Accesibilidad', () => {
    it('debería tener atributos de accesibilidad', () => {
      ...
      const hamburger = screen.queryByRole('button', { name: /menú/i })
      if (hamburger) {
  ...
  describe('Estados de carga', () => {
    it('debería manejar estado de carga del usuario', () => {
      mockGetCurrentUser.mockReturnValue(null)
      
      renderWithRouter(<Header />)
      
      // Debería mostrar opciones de usuario no logueado
      expect(screen.getByText('Iniciar Sesión')).toBeInTheDocument()
    })
  })
