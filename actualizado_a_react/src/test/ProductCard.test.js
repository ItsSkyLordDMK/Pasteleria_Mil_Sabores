...
describe('ProductCard Component', () => {
  ...
  describe('Productos con descripción larga', () => {
    it('debería truncar descripción larga', () => {
      const productoConDescripcionLarga = {
        ...mockProduct,
        descripcion: 'Esta es una descripción muy larga que debería ser truncada para mantener el diseño de la tarjeta consistente y evitar que el texto se desborde'
      }
      
      renderWithRouter(<ProductCard producto={productoConDescripcionLarga} />)
      
      // La descripción debería estar truncada
      const descripcion = screen.getByText(/Esta es una descripción/)
      expect(descripcion).toBeInTheDocument()
    })
  })

  describe('Estados de carga', () => {
    it('debería mostrar estado de carga al agregar producto', () => {
      renderWithRouter(<ProductCard producto={mockProduct} />)
  ...
  describe('Responsividad', () => {
    it('debería aplicar clases CSS responsivas', () => {
      ...
      const card = screen.getByText('Torta de Chocolate').closest('.product-card')
